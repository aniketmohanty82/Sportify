...
const generateWeeklySummary = async (userId) => {
  ...
  return {
    ...
    totalCalories: totalCaloriesBurnedFromWorkouts,
    totalCaloriesConsumed: totalCaloriesFromMeals,
...
- Total Calories Consumed (Avg. per day): ${summary.totalCaloriesConsumed / 7}
