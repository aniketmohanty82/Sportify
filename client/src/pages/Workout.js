...
//             <div key={`${exerciseName}-${index}`} className="exercise-card">
//               <h3>{exerciseName}</h3>
//               <p><span>Sets:</span> {log.sets}</p>
//               <p><span>Reps:</span> {log.reps}</p>
//               <p><span>Weight:</span> {log.weight} lbs</p>
//             </div>
//           ))
//         ))}
//       </div>
...
//           <p className="exercise-title">{log.exercise}</p>
//           <p><span>Sets:</span> {log.sets}</p>
//           <p><span>Reps:</span> {log.reps}</p>
//           <p><span>Weight:</span> {log.weight} lbs</p>
//         </div>
